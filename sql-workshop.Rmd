...
db_user <- 'xc2496'
db_password <- '1995Susan'
db_name <- 'SQLdb_Susan'
db_host <- 'database-1.c6li2rgjuaa1.us-east-2.rds.amazonaws.com'
db_port <- 3306
...
#We will use the real SQL language
#EXERCISE 1
...
#Create two random tables
set.seed(123)
words<-c("A","B","C")
words <- sample(words,50,replace = TRUE)
age <- sample(1:100, 50, replace=TRUE)
happiness <- sample(1:100, 50, replace=TRUE)
toy1<- data.frame(words,age, happiness)
toy1
set.seed(233)
words<-c("A","B","C")
words <- sample(words,50,replace = TRUE)
age <- sample(1:100, 50, replace=TRUE)
happiness <- sample(1:100, 50, replace=TRUE)
toy2<- data.frame(words,age, happiness)
toy2
#Transfer these dataframes to your SQL database using the DBI commands. Name the tables into Toy1 and Toy2.
#dbWriteTable(mydb, "Toy1", toy1)
#dbWriteTable(mydb, "Toy2", toy2)
#use "overwrite=TRUE" to update the table into sql
dbListTables(mydb)
dbListTables(mydb,"studentInfo")
```
...
dbGetQuery(mydb, "SELECT id_student AS 'Student ID', gender FROM studentInfo LIMIT 10;") #SQL Standard says quotes for literal strings and double quotes for everything else but that conflicts with R. You can change variable names by using "AS".
...
dbGetQuery(mydb, "SELECT age, happiness, words AS 'grade' FROM Toy1 ORDER BY age DESC LIMIT 20;")
...
dbGetQuery(mydb, "INSERT INTO Toy1 (age) VALUES (95);")
dbGetQuery(mydb, "UPDATE Toy2 SET age = '20' WHERE happiness=10 ;")
dbGetQuery(mydb, "SELECT * FROM Toy1;")
dbGetQuery(mydb, "SELECT * FROM Toy2;")
dbGetQuery(mydb, "DELETE FROM Toy1 WHERE happiness is NULL;")
dbGetQuery(mydb, "DELETE FROM Toy2 WHERE happiness=10;")
dbGetQuery(mydb, "SELECT * FROM Toy1;")
dbGetQuery(mydb, "SELECT * FROM Toy2;")
```
